...
<head>
    ...
    <style>
        ...
        .btn { display: inline-block; background: #4f46e5; color: #fff; text-decoration: none; padding: 12px 28px; border-radius: 8px; font-weight: 600; margin: 20px 0; }
...
<body>
    <div class="card">
        ...
        <p>Terima kasih telah mendaftar di <strong>Laravel Money</strong>. Klik tombol di bawah untuk memverifikasi alamat email kamu.</p>
