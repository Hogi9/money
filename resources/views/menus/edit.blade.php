...
@section('content')
    <div class="pb-4">
        <h1 class="text-2xl font-semibold tracking-tight">Edit Menu</h1>
        <p class="text-base-content/70 mt-1">Update menu <strong>{{ $menu->name }}</strong>. Changing the permission name
            will auto-create the new permission and assign it to admin.</p>
    </div>
        ...
        <form action="{{ route('menus.update', $menu->id) }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                ...
                <div>
                    ...
                    <input type="text" id="route_name" name="route_name" value="{{ old('route_name', $menu->route_name) }}"
                ...
                <div>
                    ...
                    <input type="text" id="group" name="group" value="{{ old('group', $menu->group) }}"
